...
namespace MyAcademy_RapidApi_Booking.Models
{
    ...
    {   
        ...
        public class RoomDetail
        {
            ...
            // Fotoğrafları karşılayan kısım

            // Diğer özellikler (Highlights, facilities vs. ihtiyacın varsa buraya ekleyebilirsin)
            // Şimdilik sadece resimler çalışsın diye bunları yazdım.public string description { get; set; }
        ...
        public class Group_By_Price
        {
            ...
            public string[] fixedper_night2183 { get; set; }
        }
